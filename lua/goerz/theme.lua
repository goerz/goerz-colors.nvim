...
theme.set_highlights = function(opts)
    ...
    hl(0, 'IncSearch', { fg = c.None, bg = c.Yellow })
    ...
    hl(0, 'Search', { fg = c.None, bg = c.Yellow })
    ...
    hl(0, '@type', { link = 'Type'})
    hl(0, '@type.qualifier', { fg = c.LightRed, bg = c.None })
    ...
    hl(0, '@tag.attribute', { fg = c.DarkBlue, bg = c.None })

    hl(0, '@text', { fg = c.Front, bg = c.None }) -- Legacy
    hl(0, '@markup.strong', { fg = c.Front, bg = c.None, bold = true })
    ...
    hl(0, '@markup.raw', { fg = c.DarkBlue, bg = c.None })
    hl(0, '@markup.raw.markdown', { fg = c.DarkBlue, bg = c.None })
    ...
    hl(0, '@markup.link.markdown_inline', { fg = c.DarkBlue, bg = c.None })
    hl(0, '@markup.link.url', { fg = c.Gray50, bg = c.None })
    ...
    hl(0, 'markdownUrl', { fg = c.Gray, bg = c.None})
