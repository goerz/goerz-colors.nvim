...
theme.set_highlights = function(opts)
    ...
    -- hl(0, '@attribute.builtin', { fg = c.Violet })
    hl(0, '@module', { fg = c.Front })
    hl(0, '@function', { fg = c.LightRed })
    ...
    -- VimTeX
    hl(0, 'texTitleArg', { fg = c.Front, bold = true })
    hl(0, 'texPartArgTitle', { fg = c.Front, bold = true })
    ...
    -- LSP
    hl(0, 'DiagnosticOk', { })
    hl(0, 'DiagnosticError', { bg = c.LSPErr })
    hl(0, 'DiagnosticWarn', { bg = c.LSPWarn })
    hl(0, 'DiagnosticInfo', { })
    hl(0, 'DiagnosticHint', { })
    hl(0, 'DiagnosticUnnecessary', { link = 'DiagnosticWarn' })
    hl(0, 'DiagnosticUnderlineError', { link = 'DiagnosticError' })
    hl(0, 'DiagnosticUnderlineWarn', { link = 'DiagnosticWarn' })
    hl(0, 'DiagnosticUnderlineInfo', { link = 'DiagnosticOk' })
    hl(0, 'DiagnosticUnderlineHint', { link = 'DiagnosticOk' })
